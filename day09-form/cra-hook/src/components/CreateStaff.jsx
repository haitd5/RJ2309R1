      ...
      <>
        ...
        <form onSubmit={handleCreateStaff}>
          <div className="form-group mb-2">
            ...
            <input type="text" className="form-control" name="fullname" value={form.values.fullname} onInput={handleInputValue}/>
            <span className="text-danger">{form.touch.fullname && form.errors?.fullname}</span>
          </div>
          <div className="form-group mb-2">
            <label>Email</label>
            <input type="email" className="form-control" name="email" value={form.values.email} onInput={handleInputValue}/>
